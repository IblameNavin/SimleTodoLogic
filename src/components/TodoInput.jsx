...
const TodoInput = ({ addInputOnSearch, value, addTodos, handlEnterKeyPress }) => {
  return (
    <div className="flex w-full max-w-md mb-6">
      <input
        type="text"
        onChange={addInputOnSearch}
        value={value}
        onKeyDown={handlEnterKeyPress} // Bind Enter key here
      ...
      <button
        ...
        onClick={addTodos} // Click still works
      >
        Add
      </button>
    </div>
